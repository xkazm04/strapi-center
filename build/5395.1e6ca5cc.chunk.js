...
`])),function(n){var t=n.theme,s=n.fontWeight;return t.fontWeights[s]},function(n){var t=n.theme,s=n.fontSize;return t.fontSizes[s]},function(n){var t=n.theme,s=n.lineHeight;return t.lineHeights[s]},function(n){var t=n.theme,s=n.textColor;return t.colors[s||"neutral800"]},function(n){return n.textTransform},function(n){return n.ellipsis&&`
  ...
  `},function(n){var t=n.variant,s=n.theme;switch(t){case"alpha":return`
      ...
      `);default:return`
        font-size: `.concat(s.fontSizes[2],`;
      `)}});T.defaultProps=w,T.propTypes=m},9:function(r,f,e){"use strict";e.r(f),e.d(f,"Flex",function(){return n});var a,o=e(3),l=e.n(o),c=e(2),d=e.n(c),i=e(6),b=e(7),g=e(1),S=e.n(g),u=e(0),p=e.n(u),w=function(t){return S.a.createElement("div",t)},m={alignItems:"center",basis:void 0,direction:"row",gap:void 0,inline:!1,justifyContent:void 0,reverse:!1,wrap:void 0},O={alignItems:p.a.string,basis:p.a.oneOfType([p.a.string,p.a.number]),direction:p.a.string,gap:p.a.oneOfType([p.a.shape({desktop:p.a.number,mobile:p.a.number,tablet:p.a.number}),p.a.number,p.a.arrayOf(p.a.number),p.a.string]),inline:p.a.bool,justifyContent:p.a.string,reverse:p.a.bool,wrap:p.a.string};w.defaultProps=m,w.propTypes=O;var T={direction:!0},n=d()(i.Box).withConfig({shouldForwardProp:function(t,s){return!T[t]&&s(t)}})(a||(a=l()([`
  align-items: `,`;
  display: `,`;
  flex-direction: `,`;
  flex-wrap: `,`;
