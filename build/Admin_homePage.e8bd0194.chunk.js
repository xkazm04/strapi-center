...
`,Fe=()=>{const{collectionTypes:t,singleTypes:a,isLoading:o}=(0,$.bP)(),{guidedTourState:l,isGuidedTourVisible:u,isSkipped:y}=(0,i.useGuidedTour)(),D=!A(l)&&u&&!y,{push:x}=(0,O.useHistory)(),M=s=>{s.preventDefault(),x("/plugins/content-type-builder/content-types/create-content-type")},p=(0,e.useMemo)(()=>{const s=Ve=>Ve.filter($e=>$e.isDisplayed);return s(t).length>1||s(a).length>0},[t,a]);return o?e.createElement(i.LoadingIndicatorPage,null):e.createElement(F.Layout,null,e.createElement(f.FormattedMessage,{id:"HomePage.helmet.title",defaultMessage:"Homepage"},s=>e.createElement(j.Helmet,{title:s[0]})),e.createElement(W.Main,null,e.createElement(Oe,null,e.createElement("img",{alt:"","aria-hidden":!0,src:V})),e.createElement(d.Box,{padding:10},e.createElement(g.Grid,null,e.createElement(g.GridItem,{col:8,s:12},e.createElement(Me,{onCreateCT:M,hasCreatedContentType:p}))),e.createElement(g.Grid,{gap:6},e.createElement(g.GridItem,{col:8,s:12},D?e.createElement(ee,null):e.createElement(je,null)),e.createElement(g.GridItem,{col:4,s:12},e.createElement(Te,null))))))},We=(0,e.memo)(Fe)},42462:(L,C,n)=>{L.exports=n.p+"fb376b132d18bf4522ca.png"}}]);
